...
using System.Linq;
using PinakesApi.Services;

namespace PinakesApi
{
    /// <summary>
    /// Main program.
    /// </summary>
    public sealed class Program
    {
        ...
        public static int Main(string[] args)
        {
            Log.Logger = new LoggerConfiguration()
                ...
                .WriteTo.Console()
#if DEBUG
                .WriteTo.File("pinakes-api-log.txt", rollingInterval: RollingInterval.Day)
#endif
                .CreateLogger();

            try
            {
                Log.Information("Starting Pinakes RAP host");
                DumpEnvironmentVars();
            ...
            {
                Log.Fatal(ex, "Pinakes RAP host terminated unexpectedly");
